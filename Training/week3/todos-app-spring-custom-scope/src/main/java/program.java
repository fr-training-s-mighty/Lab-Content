...
public class program {
	...
	public static void main(String[] args) {
		...
		TodoService todoService1 = spring_container.getBean("todoService", TodoService.class);
		
		TodoService todoService2 = spring_container.getBean("todoService", TodoService.class);
		
		System.out.println("Are the TodoService instances equal ?" + (todoService1 == todoService2));
//		performOperations(todoService,"setter injection");

//		performOperations(todoService,"constructor injection");

		performOperations(todoService1, "Field injection");
